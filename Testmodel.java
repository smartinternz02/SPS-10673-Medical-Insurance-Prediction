...
public class Testmodel {
	...
	public static void main(String args[]) {
		...
		try {
		Table insurance_data=Table.read().csv("C:\\Users\\mahesh\\Desktop\\project\\insurance.csv");
		...
		//histogram
		HistogramTrace h=HistogramTrace.builder(insurance_data.nCol("bmi"),insurance_data.nCol("charges")).build();
		Plot.show(new Figure(l1,h));
		...
		Instances train_data = getInstances("C:\\Users\\mahesh\\Desktop\\project\\traindataset.arff");
		Instances test_data = getInstances("C:\\Users\\mahesh\\Desktop\\project\\testdataset.arff");
